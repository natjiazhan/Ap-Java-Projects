...
public class CompanyTest {
    public static void main(String[] args) {
        ...
        while(read != null) {
            ...
            double net = Math.round(Utility.pay(gross, arrEmp.get(idx).getDependents())*100.0)/100.0;
            System.out.println(arrEmp.get(idx).toString()
                    + EasyFormat.format(hours, 3)
                    + EasyFormat.format(gross, 12, 2)
                    + EasyFormat.format(net, 12, 2));
